...
class Weibo(object):
    cookie = {'Cookie': '_T_WM=a34d3a3f8a69b6eade756c5754f2a051; ALF=1570699215; SUB=_2A25wcxqADeRhGeBL6lQX8SjPwz6IHXVTn6bIrDV6PUNbktAKLUajkW1NR1eE0ZTtw1OkTx9VkCZprWnRw1iGWcu9; SUBP=0033WrSXqPxfM725Ws9jqgMF55529P9D9W5jcIfRwqTr3Up9aszEPjEV5JpX5KzhUgL.FoqfeKqceKq01hz2dJLoIp7LxKML1KBLBKnLxKqL1hnLBoMcSK2cSo2ce0nE; SUHB=0WGMZRGRzIKb_c; SSOLoginState=1568107216'}
    def __init__(self,
                 filter=0,
        ...
        self.user_id = '6516616382'  # 用户id,如昵称为"Dear-迪丽热巴"的id为'1669879400'
...
def main():
    try:
        ...
        since_date = '2019-05-01'  # 起始时间，即爬取发布日期从该值到现在的微博，形式为yyyy-mm-dd
